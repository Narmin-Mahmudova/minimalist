...
import productsData from '../data/bathbody.json';
...
function BathBody() {
  ...
  const { categories, steps, types, concerns, ingredients, availability } = filtersData.bathbody;
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-5">
          <h1 className="text-3xl font-bold text-gray-900">Bath & Body</h1>
