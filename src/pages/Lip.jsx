...
import productsData from '../data/lip.json';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <p className="text-sm text-gray-400 mb-2 leading-snug">{product.concern}</p>
...
function Lip() {
  ...
  const { categories, steps, types, concerns, ingredients, availability } = filtersData.lip;
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-5">
          <h1 className="text-3xl font-bold text-gray-900">Lip</h1>
